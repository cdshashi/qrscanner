...
import cd.qrscanner.config.drawRect
...
class BitmapUtils {
    ...
    companion object {
        ...
        fun getBitMapWithRect(bitmap: Bitmap?, result: List<String>, points: List<Mat>?): Bitmap?{
            val buffer = StringBuilder()
            val newBitmap = bitmap?.drawRect { canvas, paint ->
        ...
        fun getBitmap(image: ImageProxy): Bitmap? {
            @SuppressLint("UnsafeOptInUsageError") val nv21Data = yuv420ThreePlanesToNV21(
